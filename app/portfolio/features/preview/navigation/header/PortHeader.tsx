    ...
    <header className='carouselNav'>
      ...
      >
        <div className='carouselNav__section__right' ref={carouselNavSectionRight}>
          ...
          >
            <Link
              to='https://www.linkedin.com/in/justbarker/'
              id='external-links'
              target='_blank'
            ...
            <Link
              to='https://github.com/jbarkergit/FEWD-Portfolio'
              id='external-links'
              target='_blank'
...
export function BrandicoLinkedinRect(props: SVGProps<SVGSVGElement>) {
  return (
    <svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 1000 1000' {...props}>
      {/* Icon from Brandico by Fontello - https://creativecommons.org/licenses/by-sa/3.0/ */}
      <path
        fill='currentColor'
